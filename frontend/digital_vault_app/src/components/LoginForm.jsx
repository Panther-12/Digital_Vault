    ...
    <div className="w-full flex flex-col">
      ...
      <div className="p-4 w-3/4 bg-white rounded-lg shadow-lg overflow-hidden md:flex">
        <div className="md:w-1/2 bg-blue-400 p-8">
          ...
          <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Email" className="w-full mb-4 px-3 py-2 rounded-lg bg-blue-200 text-blue-800" required />
          ...
          <button type="submit" className="w-full bg-blue-800 text-white py-2 px-4 rounded-lg hover:bg-blue-600">Login</button>
        </div>
        <div className="md:w-1/2 p-8 hidden md:block">
          <img src="https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fGNyZWRpdHxlbnwwfHwwfHx8MA%3D%3D" alt="Login" className="w-full h-auto object-cover rounded-lg" />
        </div>
      </div>
    </form>
    </div>
